<template>
    <div class="__pages">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5 col-12 display-flex">
                        <div class="width-60 text-center">
                            <h1>Greffe de barbe en Egypte</h1>
        ...
        <section class="bg-blue pt-5 pb-5">
            <div class="container">
                <h2 class="yellow mb-4">Comment se passe une greffe de barbe en Egypte ?</h2>
                <p>Quand on parle d’intervention esthétique, on ne peut pas oublier la première phase. La préparation. Cette étape, dans ce cas, consiste à une entrevue entre le patient et le docteur durant laquelle ce dernier va identifier les besoins et possibilités existantes. Une barbe fine, dense etc…<br>Le docteur marque alors les zones donneuses, ainsi que les zones receveuse. Cette étape est réalisée à l’aide d’un crayon dermographique.<br>Une fois cela fait, l’étape suivante consiste à extraire les follicules de cheveux du cuir chevelu. Il faut dans ce cas, faire attention à choisir les bons follicules. C’est-à-dire ceux qui ne possèdent pas des potentiels de futures complications, telles que l’alopécie.<br>Cette méthode est appelée greffe FUE, et elle se base sur le prélèvement et l’implantation follicule par follicule. Il existe aussi une autre méthode d’extraction par bandelette.<br>C’est-à-dire ceux qui ne possèdent pas des potentiels de futures complications, telles que l’alopécie.<br>La partie qui suit, est celle de la transplantation de ces griffons sélectionnés. Car en effet, cette procédure est assez délicate. L’expertise du docteur impact énormément le résultat cherché. Les implants sont posés, individuellement, à l’intérieur des incisions superficielles réalisées. Cela permet une précision et un contrôle sur la densité et la forme de la barbe.<br>Il faut savoir que cette intervention se passe sous anesthésie locale et peut durer jusqu’à six heures.</p>
        ...
        <section class="container">
            <div class="row">
                ...
                <div class="col-md-7 col-12">
                    ...
                    <h2 class="yellow mt-2">Combien coûte une greffe de barbe en Egypte ?</h2>
                    <p>Il faut savoir que le coût de cette intervention varie selon la clinique, le centre ou encore l’expertise du docteur. En Egypte, le coût moyen de la greffe de barbe tourne autour de 1 350 €.</p>
                </div>
            </div>
        </section>
    </div>
...
<script>
    ...
    data() {
      return {
        title: 'Greffe de barbe en Egypte'
      }
    },
    head() {
      return {
        ...
        meta: [
            ...
            { hid: 'description', name: 'description', content: 'Greffe de barbe en Egypte' }
        ],
        htmlAttrs: {
            lang: 'fr'
        },
